    ...
    private static DemoApiDefinition payinCheckout() {
        return api("payin-checkout", "payin", "代收", "创建收银台代收",
                ...
                fields(
                        ...
                        field("returnUrl", "返回地址", "支付完成后的前端跳转地址。", false, "https://manage.forgottenthrone.com/", ""),
                        field("notifyUrl", "异步通知地址", "网关支付结果通知地址。", false, "http://192.168.2.47:58080/payment-sdk/api/webhook/payin", ""),
    ...
    private static DemoApiDefinition payinDirect() {
        return api("payin-direct", "payin", "代收", "创建直连代收",
                ...
                fields(
                        ...
                        field("notifyUrl", "异步通知地址", "网关支付结果通知地址。", false, "http://192.168.2.47:58080/payment-sdk/api/webhook/payin", ""),
                        field("clientIp", "客户端 IP", "付款人客户端 IP。", false, "47.125.221.223", ""),
                        field("website", "商户网站", "商户站点或业务来源。", false, "http://192.168.2.47:5173", ""),
                        field("metadata", "透传字段", "商户自定义透传数据。", false, "metadata", ""),
                        customerMode(),
                        customerId(),
                        customerJson()),
    ...
    private static DemoApiDefinition payoutCreate() {
        return api("payout-create", "payout", "代付", "发起代付",
                ...
                fields(
                        ...
                        field("notifyUrl", "异步通知地址", "网关代付结果通知地址。", false, "http://192.168.2.47:58080/payment-sdk/api/webhook/payout", ""),
